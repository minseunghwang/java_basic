...
select ename 사원명,job as "업 무",sal as 급_여,comm as 수당 from emp;
select distinct job from emp;
select ename,sal,sal*12 as "년봉" from emp;
...
select ename,nvl(to_char(mgr),'없음') as 메니저 from emp;
...
insert into emp 
values(9999,'java01','CLERK',7782,sysdate,900,null,10);

insert into emp 
values(9999,'java01','CLERK',7782,'19/05/13',900,null,10);

insert into emp 
values(9999,'java01','CLERK',7782,to_date('05/13/19','mm/dd/yy'),900,null,10);
